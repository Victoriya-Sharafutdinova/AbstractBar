...
namespace AbstractGarmentFactoryRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<DbContext, AbstractDBScope>(new HierarchicalLifetimeManager());
            container.RegisterType<ICustomerService, CustomerServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<IStockingService, StockingServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<IFabricService, FabricServiceDB>(new HierarchicalLifetimeManager());
